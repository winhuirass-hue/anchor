...
/* AnchorSignaller is a class that manages signals between
   disconnected Anchor code. Anchor objects connect to these signals
...
/* Get the one and only AnchorSignaller to connect with or emit signals for */
GObject *anchor_signaller_get_current (void);
