/* -*- Mode: C; indent-tabs-mode: t; c-basic-offset: 8; tab-width: 8 -*-
   ...
   anchor-lib-self-check-functions.h: Wrapper and prototypes for all
   self-check functions in libanchor.
...
void anchor_run_lib_self_checks (void);
...
#define NAUTILUS_LIB_FOR_EACH_SELF_CHECK_FUNCTION(macro) \
	macro (anchor_self_check_file_utilities) \
	macro (anchor_self_check_file_operations) \
	macro (anchor_self_check_directory) \
	macro (anchor_self_check_file) \
	macro (anchor_self_check_canvas_container) \
