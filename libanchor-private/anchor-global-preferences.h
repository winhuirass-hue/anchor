...
/* anchor-global-preferences.h - Anchor specific preference keys and
                                   functions.
...
/* These IIDs are used by the preferences code and in anchor-application.c */
...
void anchor_global_preferences_init                      (void);
char *anchor_global_preferences_get_default_folder_viewer_preference_as_iid (void);

extern GSettings *anchor_preferences;
extern GSettings *anchor_icon_view_preferences;
extern GSettings *anchor_list_view_preferences;
extern GSettings *anchor_desktop_preferences;
extern GSettings *anchor_window_state;
