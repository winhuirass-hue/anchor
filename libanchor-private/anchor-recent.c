...
anchor_recent_get_manager (void)
{
...
void
anchor_recent_add_file (AnchorFile *file,
			  GAppInfo *application)
{
	...
	recent_data.mime_type = anchor_file_get_mime_type (file);
	...
	gtk_recent_manager_add_full (anchor_recent_get_manager (),
				     uri, &recent_data);
