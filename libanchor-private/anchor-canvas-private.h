...
#include <libanchor-private/anchor-canvas-item.h>
...
/* Private AnchorCanvasContainer members. */
...
struct AnchorCanvasContainerDetails {
	/* List of icons. */
	GList *icons;
	GList *new_icons;
	GHashTable *icon_set;
	...
	AnchorCanvasIcon *keyboard_focus;
	AnchorCanvasIcon *keyboard_rubberband_start;

	/* Current icon with stretch handles, so we have only one. */
	AnchorCanvasIcon *stretch_icon;
	double stretch_initial_x, stretch_initial_y;
	guint stretch_initial_size;
	
	/* Last highlighted drop target. */
	AnchorCanvasIcon *drop_target;

	/* Rubberbanding status. */
	AnchorCanvasRubberbandInfo rubberband_info;
	...
	AnchorCanvasIcon *keyboard_icon_to_reveal;
	...
	AnchorCanvasIcon *double_click_icon[2]; /* Both clicks in a double click need to be on the same icon */
	guint double_click_button[2];

	AnchorCanvasIcon *range_selection_base_icon;
	...
	/* Label position */
	AnchorCanvasLabelPosition label_position;
...
AnchorCanvasIcon *anchor_canvas_container_get_icon_by_uri             (AnchorCanvasContainer *container,
									 const char            *uri);
void          anchor_canvas_container_move_icon                   (AnchorCanvasContainer *container,
...
void          anchor_canvas_container_select_list_unselect_others (AnchorCanvasContainer *container,
								     GList                 *icons);
char *        anchor_canvas_container_get_icon_uri                (AnchorCanvasContainer *container,
								       AnchorCanvasIcon          *canvas);
char *        anchor_canvas_container_get_icon_activation_uri     (AnchorCanvasContainer *container,
								     AnchorCanvasIcon          *canvas);
char *        anchor_canvas_container_get_icon_drop_target_uri    (AnchorCanvasContainer *container,
								       AnchorCanvasIcon          *canvas);
void          anchor_canvas_container_update_icon                 (AnchorCanvasContainer *container,
								       AnchorCanvasIcon          *canvas);
gboolean      anchor_canvas_container_has_stored_icon_positions   (AnchorCanvasContainer *container);
gboolean      anchor_canvas_container_scroll                      (AnchorCanvasContainer *container,
								     int                    delta_x,
								     int                    delta_y);
void          anchor_canvas_container_update_scroll_region        (AnchorCanvasContainer *container);
