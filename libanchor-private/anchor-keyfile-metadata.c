...
void
anchor_keyfile_metadata_set_string (AnchorFile *file,
                                      ...
                                      const gchar *string)
{
	...
	if (anchor_keyfile_metadata_update_from_keyfile (file, keyfile_filename, name)) {
		anchor_file_changed (file);
	}
}

#define STRV_TERMINATOR "@x-anchor-desktop-metadata-term@"

void
anchor_keyfile_metadata_set_stringv (AnchorFile *file,
                                       const char *keyfile_filename,
                                       const char *name,
                                       const char *key,
...
gboolean
anchor_keyfile_metadata_update_from_keyfile (AnchorFile *file,
                                               const char *keyfile_filename,
                                               const gchar *name)
{
	gchar **keys, **values;
	...
	res = anchor_file_update_metadata_from_info (file, info);
