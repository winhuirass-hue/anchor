...
G_DEFINE_TYPE (AnchorConnectServerDialog, anchor_connect_server_dialog,
	       GTK_TYPE_DIALOG)

GFile *
anchor_connect_server_dialog_get_location (AnchorConnectServerDialog *dialog)
{
	const char *uri;
	GFile *file = NULL;
...
static gboolean
is_scheme_supported (AnchorConnectServerDialog *dialog,
		     const char                  *scheme)
{
	int i;
...
static gboolean
validate_uri (AnchorConnectServerDialog *dialog,
	      const char                  *uri,
	      GError                     **error)
{
...
on_uri_entry_clear (GtkEntry                    *entry,
		    AnchorConnectServerDialog *dialog)
{
	gtk_entry_set_text (entry, "");
}

static const char *
get_default_schema (AnchorConnectServerDialog *dialog)
{
	if (dialog->details->supported == NULL) {
		return NULL;
	}
...
static void
populate_supported_list (AnchorConnectServerDialog *dialog)
{
...
static void
reset_example_label (AnchorConnectServerDialog *dialog)
{
	char *text;
	char *uri;
	const char *schema;
...
static void
check_uri_entry (AnchorConnectServerDialog *dialog)
{
	guint length;
	gboolean rtl;
...
static char *
get_selected (AnchorConnectServerDialog *dialog,
...
server_list_load (AnchorConnectServerDialog *dialog)
{
...
static void
server_list_save (AnchorConnectServerDialog *dialog,
		  GBookmarkFile               *bookmarks)
{
	char *filename;

	filename = g_build_filename (g_get_user_config_dir (), "anchor", "servers", NULL);
	g_bookmark_file_to_file (bookmarks, filename, NULL);
}

static void
populate_server_list (AnchorConnectServerDialog *dialog)
{
	GBookmarkFile *bookmarks;
	GtkTreeIter iter;
	char **uris;
...
static void
server_list_remove (AnchorConnectServerDialog *dialog,
		    const char                  *uri)
{
	GBookmarkFile *bookmarks;
...
static void
server_list_remove_all (AnchorConnectServerDialog *dialog)
{
	GBookmarkFile *bookmarks;
...
on_popup_menu_detach (GtkWidget *attach_widget,
		      GtkMenu   *menu)
{
	AnchorConnectServerDialog *dialog = NAUTILUS_CONNECT_SERVER_DIALOG (attach_widget);
...
static void
create_popup_menu (AnchorConnectServerDialog *dialog)
{
	GtkWidget *menu;
	GtkWidget *item;
...
static void
history_popup_menu (AnchorConnectServerDialog *dialog)
{
...
static void
anchor_connect_server_dialog_init (AnchorConnectServerDialog *dialog)
{
	GtkWidget *label;
	GtkWidget *sw;
	GtkWidget *view;
	...
	dialog->details = G_TYPE_INSTANCE_GET_PRIVATE (dialog, ANCHOR_TYPE_CONNECT_SERVER_DIALOG,
						       AnchorConnectServerDialogDetails);
...
static void
anchor_connect_server_dialog_finalize (GObject *object)
{
	AnchorConnectServerDialog *dialog;
	...
	G_OBJECT_CLASS (anchor_connect_server_dialog_parent_class)->finalize (object);
}

static void
anchor_connect_server_dialog_class_init (AnchorConnectServerDialogClass *class)
{
	GObjectClass *oclass;

	oclass = G_OBJECT_CLASS (class);
	oclass->finalize = anchor_connect_server_dialog_finalize;

	g_type_class_add_private (class, sizeof (AnchorConnectServerDialogDetails));
}

GtkWidget *
anchor_connect_server_dialog_new (AnchorWindow *window)
{
	GtkWidget *dialog;

	dialog = gtk_widget_new (ANCHOR_TYPE_CONNECT_SERVER_DIALOG,
				 "use-header-bar", TRUE,
				 NULL);
