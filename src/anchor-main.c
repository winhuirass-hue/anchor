...
/* anchor-main.c: Implementation of the routines that drive program lifecycle and main window creation/destruction. */
...
main (int argc, char *argv[])
{
	...
	/* Anchor uses lots and lots of small and medium size allocations,
	 ...
	 * be mmaped. Unfortunately this triggers quickly for anchor when
	...
	g_set_prgname ("anchor");

#ifdef HAVE_EXEMPI
	xmp_init();
#endif

	/* Run the anchor application. */
	application = anchor_application_new ();
