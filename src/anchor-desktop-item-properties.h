 ...
 * a property notebook page, which implemented the AnchorPropertyPageProvider
 * interface.
 *
...
GtkWidget *anchor_desktop_item_properties_make_box (GtkSizeGroup *label_size_group,
                                                      GList *files);
gboolean   anchor_desktop_item_properties_should_show (GList *files);
