...
#include <gtk/gtk.h>
#include <libanchor-private/anchor-mime-actions.h>
#include <stdio.h>
...
main (int argc, char **argv)
{
	...
	attributes = anchor_mime_actions_get_full_file_attributes ();
	anchor_file_call_when_ready (file, attributes, ready_callback, NULL);
